...
import { employeeArray } from '../store/EmployeeArray';

export const NewEmployee=({ onEmployeeAdded }: { onEmployeeAdded: () => void })=>{

    const [employee,setEmployee]=useState({ name : '', department : '', salary : 0 });
    ...
    const handleSelectChange=(change:SelectChangeEvent)=>{
        ...
        const post = (event:React.MouseEvent<SVGSVGElement, MouseEvent>)=>{
